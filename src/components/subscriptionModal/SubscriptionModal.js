...
import Whatsapp from "../../assets/appImages/svgImages/Whatsapp";
import { useSafeAreaInsets } from "react-native-safe-area-context";
import ZoulAppIcon from "../../assets/appImages/svgImages/ZoulAppIcon.svg";
import Tick from "../../assets/appImages/svgImages/tick.svg";
import UnTick from "../../assets/appImages/svgImages/untick.svg";
import { Backgrounds } from "../../data/background";
import { CloseIcon } from "../common/SvgIcons/Icon";
  ...
  const savePurchaseData = async (purchase) => {
    ...
    try {
      ...
      if (res?.status == 201) {
        ...
        setIsPageLoading(false);
        setIsLoading(false);
        onSubscribedUser(selectSubscriptionPlan);
        LogPurchaseEvent();
        onClose();
      } else {
        Alert.alert(
              ...
              >
                ...
                <Block flex={false} row between>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => onClose()}
                  >
                    <Block flex={false} row center gap={4}>
                      <Text
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            setSelectSubscriptionPlan(
                              isApplied == true ? YEARLY_PROMO : YEARLY
                            )
                          }
                        >
                          <Block>
                    ...
                    >
                      <Block flex={false} style={{ width: "100%" }}>
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            setSelectSubscriptionPlan(
                              isApplied == true ? MONTHLY_PROMO : MONTHLY
                            )
                          }
                        >
                          <Block>
